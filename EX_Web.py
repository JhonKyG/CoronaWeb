    ...
    for i in range(len(id)):
        try:
            ...
            if(mes.strftime('%m') == '03'):
                count3[0]+=1
                values3.insert(2, count3[0])
            elif(mes.strftime('%m') == '04'):
                count3[1]+=1
                values3.insert(3, count3[1])
            elif(mes.strftime('%m') == '05'):
                count3[2]+=1
                values3.insert(4, count3[2])
        except:
            c=1

    legend3 = 'Infectados diagnosticados por mes'
    labels2 = ["Enero", "Febrero", "Marzo", "Abril", "Mayo"]
    #===================================================================================================================
    ...
    for i in range(len(id6)):
        try:
            ...
            if (mes2.strftime('%m') == '03'):
                count6[0] += 1
                values6.insert(2, count6[0])
            elif (mes2.strftime('%m') == '04'):
                count6[1] += 1
                values6.insert(3, count6[1])
            elif (mes2.strftime('%m') == '05'):
                count6[2] += 1
                values6.insert(4, count6[2])
        except:
            pollo = 1

    legend6 = 'Recuperados por mes'
    labels6 = ["Enero", "Febrero", "Marzo", "Abril", "Mayo"]
    #===================================================================================================================
